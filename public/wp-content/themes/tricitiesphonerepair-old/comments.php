 ...
 * handled by a callback to tricitiesphonerepair_comment() which is
...
<div id="comments" class="row">
	<?php if ( post_password_required() ) : ?>
		<p class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.', 'tricitiesphonerepair' ); ?></p>
	<?php
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * See tricitiesphonerepair_comment() in inc/functions/comments.php for more.
				 */
				wp_list_comments( array( 'callback' => 'tricitiesphonerepair_comment' ) );
			?>
		</ol>

		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // are there comments to navigate through ?>
		<nav id="comment-nav-below">
			<h1 class="assistive-text"><?php _e( 'Comment navigation', 'tricitiesphonerepair' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'tricitiesphonerepair' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'tricitiesphonerepair' ) ); ?></div>
		</nav>
	...
	?>
		<p class="nocomments"><?php _e( 'Comments are closed.', 'tricitiesphonerepair' ); ?></p>
	<?php endif; ?>
